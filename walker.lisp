...
(defun form-bindings-2 (ast)
  (second (form-bindings ast)))
(defun form-bindings-3 (ast)
  (third (form-bindings ast)))
(defun form-bindings-4 (ast)
  (fourth (form-bindings ast)))
(defun form-bindings-5 (ast)
  (fifth (form-bindings ast)))
(defun form-bindings-6 (ast)
  (sixth (form-bindings ast)))
(defun form-bindings-7 (ast)
...
(defun test-parse-symbol-reference ()
  ...
  (flet ((namespace-at (form)
	...
	(assert (equal (nso-sites b-sym) (list (form-bindings-2 ast))))))
	...
	(assert (equal (nso-sites b-sym) (list (form-body-1 (form-bindings-2 ast)))))))
	...
	(assert (equal (nso-sites a-2) (list (form-body-2 (form-bindings-2 ast))))))))
