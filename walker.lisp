	      ...
	      (labels ((make-var-binding (def lexical-namespace)
			 ...
			 (multiple-value-bind (fun-type name) (valid-function-name-p (car def))
			   ...
			   (let* ((body-form (cdr def))
				  ...
				  (lexical-namespace (ecase head ((flet macrolet) lexical-namespace) ((labels) lexical-namespace)))) ;for a LABELS-form, the LEXICAL-NAMESPACE already contains a fake SYM.
